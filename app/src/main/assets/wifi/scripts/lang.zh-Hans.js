...
STRINGS.WIFI_TRANS_TITLE = 'Android文件传输';
...
STRINGS.UPLOAD_FAILED = '上传失败，请重新打开APP服务并刷新此页重新上传。';
...
STRINGS.CANCEL = '取消';
STRINGS.SELECT_YOUR_FILES = '请选择您要传输到Android设备的文件';
STRINGS.SUPPORTED_FILE_TYPES = '';
STRINGS.CANNOT_CONNECT_SERVER = '无法连接服务器，请重新打开APP安装服务并刷新此页后重新上传。';
...
STRINGS.WIFI_AVAILABLE = "Android连接已启用";

STRINGS.FONT_WIFI_TRANS_TITLE = 'Android 传字体';
